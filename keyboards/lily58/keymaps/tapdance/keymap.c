...
[_LINUX] = LAYOUT( \
  ...
  KC_LCTRL, KC_A,   KC_S,    KC_D,    KC_F,    KC_G,                     KC_H,    KC_J,    KC_K,    KC_L,    TD(CT_CLN), KC_QUOT, \
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_LBRC,  KC_RBRC,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  KC_RSFT, \
                        MO(_LOWER), KC_LCTRL, KC_LALT, KC_SPC, KC_ENT, KC_BSPC, KC_RGUI, MO(_RAISE) \
),
/* LOWER
 * ,-----------------------------------------.                    ,-----------------------------------------.ß
 * |      |      |      |      |      |      |                    |      |      |      |      |      |      |
...
[_RAISE] = LAYOUT( \
  TG(_LINUX), TG(_QWERTY), _______, LCTL(KC_LEFT), LCTL(KC_UP), LCTL(KC_RGHT),              _______,_______ ,_______ , LGUI(LALT(KC_LEFT)), LGUI(LALT(KC_RGHT)), LGUI(LALT(KC_C)), \
